...
var reportname='<?php echo base_url().'attendance_report/';?>'+reportname;
	...
	data: {month: month,
	       year: year,
		   coustomer:$("#coustomer option:selected").val()
	},
...
//});
    ...
    <div class="content">
       <div style="width: 98%;margin: 20px auto;">
		...
		From:&nbsp;&nbsp;&nbsp;<input id="from" type="text" name="from"  size="40"  readonly="readonly" style="width:100px;"/> 
       
		&nbsp;&nbsp;&nbsp;To:&nbsp;&nbsp;&nbsp;<input id="to" type="text" name="to"  size="40"  readonly="readonly" style="width:100px;"/> 
        &nbsp;&nbsp;&nbsp;
           <tr >
